    ...
    <div class="libreta-content">
        ...
        <div class="libreta-page left-page">
            ...
            <div class="book-details">
                ...
                <p class="book-author">Autor: {{ implode(', ', $book['volumeInfo']['authors']) }}</p>
                @endif
            ...
            <div class="book-management">
                <form action="{{ route('libros.add-to-list') }}" method="POST" class="management-form">
                    @csrf
                ...
                <div class="action-buttons">
                    <div class="action-group">
                        ...
                        <select class="select2-recomendar" style="width: 100%">
                            <option></option>
                    ...
                    <div class="action-group">
                        ...
                        <select class="select2-prestar" style="width: 100%">
                            <option></option>
                            @foreach(Auth::user()->amigos as $amigo)
                            <option value="{{ $amigo->id }}">{{ $amigo->name }}</option>
                            @endforeach
